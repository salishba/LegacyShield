...
function createStack(options = {}) {
  ...
  const Stack3 = React16.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var Paper = React20.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var TouchRipple = React28.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  return (0, import_jsx_runtime18.jsx)(TouchRippleRoot, _extends({
...
var ButtonBase = React29.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  return (0, import_jsx_runtime20.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime19.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var IconButton = React30.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  return (0, import_jsx_runtime21.jsx)(IconButtonRoot, _extends({
    className: clsx_default(classes.root, className),
    centerRipple: true,
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types24.default.node, (props) => {
    const found = React30.Children.toArray(props.children).some((child) => React30.isValidElement(child) && child.props.onClick);
    if (found) {
...
var Typography = React31.forwardRef(function Typography2(inProps, ref) {
...
var Portal = React33.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime23.jsx)(React33.Fragment, {
      children: children2
    });
  }
  return (0, import_jsx_runtime23.jsx)(React33.Fragment, {
...
var Popper3 = React35.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
var ListSubheader = React36.forwardRef(function ListSubheader2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListSubheader"
  });
...
var Chip = React38.forwardRef(function Chip2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React38.useRef(null);
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color,
    iconColor: React38.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React38.isValidElement(deleteIconProp) ? React38.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && React38.isValidElement(avatarProp)) {
    avatar = React38.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React38.isValidElement(iconProp)) {
    icon = React38.cloneElement(iconProp, {
...
var TextareaAutosize = React39.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React39.useRef(null);
  const hiddenTextareaRef = React39.useRef(null);
  const calculateTextareaStyles = React39.useCallback(() => {
  ...
  const syncHeight = React39.useCallback(() => {
    const textarea = textareaRef.current;
    const textareaStyles = calculateTextareaStyles();
    if (!textarea || !textareaStyles || isEmpty2(textareaStyles)) {
      return;
  ...
  const frameRef = React39.useRef(-1);
  useEnhancedEffect_default(() => {
  ...
  return (0, import_jsx_runtime31.jsxs)(React39.Fragment, {
    children: [(0, import_jsx_runtime30.jsx)("textarea", _extends({
      value,
      onChange: handleChange,
      ref: handleRef,
      rows: minRows,
      style: style2
    }, other)), (0, import_jsx_runtime30.jsx)("textarea", {
      "aria-hidden": true,
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime32.jsx)(GlobalStyles_default, _extends({}, props, {
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  }));
}
...
var inputGlobalStyles = (0, import_jsx_runtime33.jsx)(GlobalStyles_default2, {
  styles: {
...
var InputBase = React43.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React43.Fragment, {
...
var Close_default = createSvgIcon((0, import_jsx_runtime35.jsx)("path", {
...
var Autocomplete = React46.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    ChipProps,
    className,
    clearIcon = _ClearIcon || (_ClearIcon = (0, import_jsx_runtime37.jsx)(Close_default, {
      fontSize: "small"
    })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon || (_ArrowDropDownIcon = (0, import_jsx_runtime37.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => {
        ...
        return (0, import_jsx_runtime37.jsx)(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push((0, import_jsx_runtime37.jsx)("span", {
        className: classes.tag,
        children: getLimitTagsText(more)
      }, startAdornment.length));
    }
  }
  const defaultRenderGroup = (params) => (0, import_jsx_runtime38.jsxs)("li", {
    children: [(0, import_jsx_runtime37.jsx)(AutocompleteGroupLabel, {
      className: classes.groupLabel,
      ownerState,
      component: "div",
      children: params.group
    }), (0, import_jsx_runtime37.jsx)(AutocompleteGroupUl, {
  ...
  const defaultRenderOption = (props2, option) => {
    ...
    return (0, import_jsx_runtime37.jsx)("li", _extends({}, otherProps, {
  ...
  return (0, import_jsx_runtime38.jsxs)(React46.Fragment, {
    children: [(0, import_jsx_runtime37.jsx)(AutocompleteRoot, _extends({
      ref,
      className: clsx_default(classes.root, className),
      ownerState
    }, getRootProps(other), {
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: (0, import_jsx_runtime38.jsxs)(AutocompleteEndAdornment, {
            className: classes.endAdornment,
            ownerState,
            children: [hasClearIcon ? (0, import_jsx_runtime37.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? (0, import_jsx_runtime37.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? (0, import_jsx_runtime37.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: (0, import_jsx_runtime38.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        className: clsx_default(classes.paper, paperSlotProps == null ? void 0 : paperSlotProps.className),
        children: [loading && groupedOptions.length === 0 ? (0, import_jsx_runtime37.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, groupedOptions.length === 0 && !freeSolo && !loading ? (0, import_jsx_runtime37.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime37.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
...
var Fade = React47.forwardRef(function Fade2(props, ref) {
  const theme = useTheme4();
  ...
  return (0, import_jsx_runtime39.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React47.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
...
var Backdrop = React48.forwardRef(function Backdrop2(inProps, ref) {
...
var Badge = React49.forwardRef(function Badge2(inProps, ref) {
...
var ButtonGroupButtonContext = React51.createContext(void 0);
if (true) {
...
var SwitchBase = React53.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
var CircularProgress = React58.forwardRef(function CircularProgress2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiCircularProgress"
  });
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(React59.Fragment, {
    children: React59.cloneElement(children2, childrenProps)
  });
}
...
function FocusTrap(props) {
  ...
  const ignoreNextEnforceFocus = React60.useRef(false);
  const sentinelStart = React60.useRef(null);
  const sentinelEnd = React60.useRef(null);
  const nodeToRestore = React60.useRef(null);
  const reactFocusEventTarget = React60.useRef(null);
  const activated = React60.useRef(false);
  const rootRef = React60.useRef(null);
  const handleRef = useForkRef(getReactElementRef(children2), rootRef);
  const lastKeydown = React60.useRef(null);
  React60.useEffect(() => {
  ...
  return (0, import_jsx_runtime54.jsxs)(React60.Fragment, {
    ...
    }), React60.cloneElement(children2, {
      ref: handleRef,
      onFocus
...
var Modal = React62.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime55.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime56.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime55.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime55.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var Divider = React63.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(DividerRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
    ...
    children: children2 ? (0, import_jsx_runtime57.jsx)(DividerWrapper, {
...
var FilledInput = React64.forwardRef(function FilledInput2(inProps, ref) {
...
var FormControl = React65.forwardRef(function FormControl2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React65.useState(() => {
    ...
    if (children2) {
      React65.Children.forEach(children2, (child) => {
...
var FormControlLabel = React66.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime61.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React66.cloneElement(control, controlProps), required ? (0, import_jsx_runtime61.jsxs)(Stack_default2, {
      display: "block",
...
var FormHelperText = React67.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
  ...
  return (0, import_jsx_runtime62.jsx)(FormHelperTextRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var FormLabel = React68.forwardRef(function FormLabel2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormLabel"
  });
  ...
  return (0, import_jsx_runtime63.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [children2, fcs.required && (0, import_jsx_runtime63.jsxs)(AsteriskComponent2, {
      ownerState,
      "aria-hidden": true,
      className: classes.asterisk,
      children: [" ", "*"]
  ...
  return (0, import_jsx_runtime66.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime66.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime66.jsx)(Typography_default, {
        ...
        children: children2
      }) : (0, import_jsx_runtime67.jsxs)(React71.Fragment, {
...
var ListContext = React74.createContext({});
if (true) {
...
var List = React75.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
...
var MenuList = React78.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  const textCriteriaRef = React78.useRef({
    keys: [],
    repeating: true,
  ...
  React78.Children.forEach(children2, (child, index) => {
  ...
  const items = React78.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React78.cloneElement(child, newChildProps);
    }
    return child;
  });
...
var Popover = React79.forwardRef(function Popover2(inProps, ref) {
  ...
  const getAnchorOffset = React79.useCallback(() => {
  ...
  const getTransformOrigin = React79.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React79.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React79.useState(open);
  const setPositioningStyles = React79.useCallback(() => {
  ...
  React79.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
  ...
  return (0, import_jsx_runtime77.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
...
var Menu = React80.forwardRef(function Menu2(inProps, ref) {
  ...
  const menuListActionsRef = React80.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React80.Children.map(children2, (child, index) => {
  ...
  return (0, import_jsx_runtime80.jsx)(NotchedOutlineRoot, _extends({
    ...
    children: (0, import_jsx_runtime80.jsx)(NotchedOutlineLegend, {
      ...
      children: withLabel ? (0, import_jsx_runtime80.jsx)("span", {
        ...
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime80.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      )
...
var OutlinedInput = React83.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime82.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime82.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime81.jsxs)(React83.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var SelectInput = React85.forwardRef(function SelectInput2(props, ref) {
  ...
  const childrenArray = React85.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime86.jsxs)(React85.Fragment, {
    children: [(0, import_jsx_runtime85.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty3(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span4 || (_span4 = (0, import_jsx_runtime85.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
    })), (0, import_jsx_runtime85.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime85.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime85.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
true ? SelectInput.propTypes = {
   ...
   * @ignore
   */
  type: import_prop_types67.default.any,
  /**
   * The input value.
   */
...
var Select = React86.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime87.jsx)(React86.Fragment, {
...
true ? Select.propTypes = {
   ...
   * @default false
   */
  native: import_prop_types68.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   */
  value: import_prop_types68.default.oneOfType([import_prop_types68.default.oneOf([""]), import_prop_types68.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
var Tooltip = React88.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children2 = React88.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime89.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme4();
  const isRtl = useRtl();
  ...
  React88.useEffect(() => stopTouchInteraction, [stopTouchInteraction]);
  const handleOpen = (event) => {
  ...
  return (0, import_jsx_runtime90.jsxs)(React88.Fragment, {
    children: [React88.cloneElement(children2, childrenProps), (0, import_jsx_runtime89.jsx)(PopperComponent, _extends({
      ...
      }) => (0, import_jsx_runtime89.jsx)(TransitionComponent, _extends({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: (0, import_jsx_runtime90.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow2 ? (0, import_jsx_runtime89.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
...
var Tablelvl2Context = React90.createContext();
if (true) {
...
var TableCell = React91.forwardRef(function TableCell2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableCell"
  });
  ...
  return (0, import_jsx_runtime91.jsx)(TableCellRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    "aria-sort": ariaSort,
...
var Toolbar = React92.forwardRef(function Toolbar2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiToolbar"
  });
  ...
  return (0, import_jsx_runtime92.jsx)(ToolbarRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
true ? Toolbar.propTypes = {
   ...
   * @default 'regular'
   */
  variant: import_prop_types72.default.oneOfType([import_prop_types72.default.oneOf(["dense", "regular"]), import_prop_types72.default.string])
} : void 0;
...
var KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime93.jsx)("path", {
...
var KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime94.jsx)("path", {
...
var TablePaginationActions = React97.forwardRef(function TablePaginationActions2(props, ref) {
  ...
  return (0, import_jsx_runtime98.jsxs)("div", _extends({
    ref
  }, other, {
    children: [showFirstButton && (0, import_jsx_runtime97.jsx)(FirstButtonSlot, _extends({
      onClick: handleFirstPageButtonClick,
      disabled: disabled || page === 0,
      "aria-label": getItemAriaLabel("first", page),
      title: getItemAriaLabel("first", page)
    }, firstButtonSlotProps, {
      children: isRtl ? (0, import_jsx_runtime97.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon)) : (0, import_jsx_runtime97.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon))
    })), (0, import_jsx_runtime97.jsx)(PreviousButtonSlot, _extends({
      ...
      children: isRtl ? (0, import_jsx_runtime97.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon)) : (0, import_jsx_runtime97.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon))
    })), (0, import_jsx_runtime97.jsx)(NextButtonSlot, _extends({
      ...
      children: isRtl ? (0, import_jsx_runtime97.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon)) : (0, import_jsx_runtime97.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon))
    })), showLastButton && (0, import_jsx_runtime97.jsx)(LastButtonSlot, _extends({
      onClick: handleLastPageButtonClick,
      disabled: disabled || page >= Math.ceil(count / rowsPerPage) - 1,
      "aria-label": getItemAriaLabel("last", page),
      title: getItemAriaLabel("last", page)
    }, lastButtonSlotProps, {
      children: isRtl ? (0, import_jsx_runtime97.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon)) : (0, import_jsx_runtime97.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon))
    }))]
  }));
});
true ? TablePaginationActions.propTypes = {
  ...
  slotProps: import_prop_types73.default.shape({
    ...
    firstButtonIcon: import_prop_types73.default.object,
    lastButton: import_prop_types73.default.object,
    lastButtonIcon: import_prop_types73.default.object,
    nextButton: import_prop_types73.default.object,
    nextButtonIcon: import_prop_types73.default.object,
    previousButton: import_prop_types73.default.object,
    previousButtonIcon: import_prop_types73.default.object
  }),
  /**
  ...
  slots: import_prop_types73.default.shape({
    firstButton: import_prop_types73.default.elementType,
    firstButtonIcon: import_prop_types73.default.elementType,
    lastButton: import_prop_types73.default.elementType,
    lastButtonIcon: import_prop_types73.default.elementType,
    nextButton: import_prop_types73.default.elementType,
    nextButtonIcon: import_prop_types73.default.elementType,
    previousButton: import_prop_types73.default.elementType,
    previousButtonIcon: import_prop_types73.default.elementType
  })
} : void 0;
...
var TablePagination = React98.forwardRef(function TablePagination2(inProps, ref) {
  ...
  return (0, import_jsx_runtime99.jsx)(TablePaginationRoot, _extends({
    colSpan,
    ref,
    as: component,
    ownerState,
    ...
    children: (0, import_jsx_runtime100.jsxs)(TablePaginationToolbar, {
      className: classes.toolbar,
      children: [(0, import_jsx_runtime99.jsx)(TablePaginationSpacer, {
        className: classes.spacer
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime99.jsx)(TablePaginationSelectLabel, {
        className: classes.selectLabel,
        id: labelId,
        children: labelRowsPerPage
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime99.jsx)(TablePaginationSelect, _extends({
        variant: "standard"
      }, !selectProps.variant && {
      ...
      })), (0, import_jsx_runtime99.jsx)(TablePaginationDisplayedRows, {
...
var TextField = React99.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime101.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime102.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime101.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime101.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children: children2
    })) : InputElement, helperText && (0, import_jsx_runtime101.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-V6FNH6EL.js.map
